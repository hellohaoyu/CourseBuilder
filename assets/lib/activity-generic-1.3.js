...
function generateMultipleChoiceQuestion(params, domRoot, index) {
  ...
  domRoot.append('<br>');
  domRoot.append('<p/><button class="button" ' +
...
function generateMultipleChoiceGroupQuestion(params, domRoot, index) {
  ...
  domRoot.append(
      '<p/><button class="button" id="submit_' +
...
function renderAssessment(assessment, domRoot) {
  ...
  if (assessmentGlobals.isReviewForm) {
    domRoot.append(
        '<br><button type="button" class="button" id="saveDraftBtn">' +
        trans.SAVE_DRAFT_TEXT + '</button>&nbsp;&nbsp;' +
        '<button type="button" class="button" id="submitAnswersBtn">' +
        trans.SUBMIT_REVIEW_TEXT + '</button>');
  } else {
    if (assessment.checkAnswers) {
      domRoot.append(
          '<button type="button" class="button" id="checkAnswersBtn">' +
    ...
    domRoot.append(
        '<br><button type="button" class="button" id="submitAnswersBtn" ' +
